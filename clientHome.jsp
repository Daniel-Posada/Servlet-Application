...
<body style="background-color:DarkOliveGreen;">
  <h1 style="color:darkseagreen; font-family:impact; text-align: center;">
    Welcome to the Fall 2024 Project 4 Enterprise System
  </h1>
  <h2 style="color:darkseagreen; font-family:arial black; text-align: center;">
    A Servlet/JSP-based Multi-tiered Enterprise Application Using a Tomcat Container
  </h2>

  <hr style = "height: 3px; border:none; background-color:darkseagreen;">
  <h3>
  ...
  <h2 style="color:lightcyan; text-align: center; font-family: Gill Sans MT, sans-serif;">
    Execution Results
  </h2>
